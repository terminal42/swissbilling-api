...
/**
 * @method TransactionStatus EshopTransactionRequest(Merchant $merchant, Transaction $transaction, Debtor $debtor, integer $count, array<InvoiceItem> $items)
 * @method TransactionStatus EshopTransactionDirect(Merchant $merchant, Transaction $transaction, Debtor $debtor, integer $count, array<InvoiceItem> $items)
 * @method TransactionStatus EshopTransactionByPass(Merchant $merchant, Transaction $transaction, Debtor $debtor, integer $count, array<InvoiceItem> $items)
